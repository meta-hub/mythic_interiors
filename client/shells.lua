function CreateHotel(spawn)
  ...
  while not HasModelLoaded(`playerhouse_hotel`) do RequestModel(`playerhouse_tier3`); Wait(0); end
...
function CreateTier1House(spawn, isBackdoor)
  ...
  while not HasModelLoaded(`playerhouse_tier1`) do RequestModel(`playerhouse_tier3`); Wait(0); end
